...
points.sort(function(a,b){
    return a-b      //오름차순이라면 a-b가 음수 일떄 a가 b 보다 앞에있다.
})

console.log("number 값 정렬 : " + points)
points.sort(function (a, b){
return b-a          //내림차순 이라면 b-a가 양수일때 b가 a보다 앞에있다.
})
